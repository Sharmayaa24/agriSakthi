...
import CustomMenuItem from "../screen/common/CustomMenu";
import vendormenuItems from "../screen/common/vendorMenu";
...
const VendorSideBar = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsSmallCollapsed(window.innerWidth < 650);
    };
    handleResize();
